...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @var boolean
     */
    public $auto_literal = SMARTY_AUTO_LITERAL;
    /**
     ...
     * @var array
     */
    private $template_dir = array(SMARTY_TEMPLATE_DIR);
    /**
     ...
     * @var string
     */
    private $compile_dir = SMARTY_COMPILE_DIR;
    /**
     * plugins directory
     * @var array
     */
    private $plugins_dir = array(SMARTY_PLUGINS_DIR);
    /**
     * cache directory
     * @var string
     */
    private $cache_dir = SMARTY_CACHE_DIR;
    /**
     * config directory
     * @var array
     */
     ...
     * @var boolean
     */
    public $force_compile = SMARTY_COMPILE_FORCE;
    /**
     * check template for modifications?
     * @var boolean
     */
    public $compile_check = SMARTY_COMPILE_CHECK;
    /**
     * use sub dirs for compiled/cached files?
     * @var boolean
     */
    public $use_sub_dirs = SMARTY_USE_SUB_DIRS;
    /**
     ...
     * @var integer
     */
    public $cache_lifetime = SMARTY_CACHE_LIFETIME;
    /**
     * force cache file creation
     * @var boolean
     */
    public $force_cache = SMARTY_CACHE_FORCE;
    /**
     ...
     * @var string
     */
    public $left_delimiter = SMARTY_LEFT_DELIMITER;
    /**
     * template right-delimiter
     * @var string
     */
    public $right_delimiter = SMARTY_RIGHT_DELIMITER;
    /**#@+
     * security
     */
    /**
